    ...
    const interval = setInterval(() => {
      setAnalysisProgress((prevProgress) => {
        if (prevProgress >= 100) {
          ...
          // Navigate to AI content report page
          router.push({
        ...
        >
          ...
          <TabsContent value="text" className="w-full">
            <div className="bg-background border rounded-lg p-6 shadow-sm min-h-[500px]">
              ...
              />
              <div className="flex items-center ml-1 mt-4 w-full">
                <div className="flex-grow text-xs text-muted-foreground pr-6"> By clicking "DETECT", you agree to terms and conditions of AI Content Detection.
                </div>
                <Button 
                  onClick={handleAnalyze} 
